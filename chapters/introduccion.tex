...
Por ejemplo, cuando dos estructuras con diferencias en segmentos espec\'{i}ficos  presentan valores globales de \textit{rmsd}, ocultan variaciones funcionalmente relevantes. Por esta raz\'{o}n, es necesario desarrollar m\'{e}todos alternativos o complementarios que permitan comparar estructuras a un nivel local, enfoc\'{a}ndose en regiones cr\'{i}ticas que eviten pequeñas fluctuaciones estructurales que distorsionan la comparaci\'{o}n global \cite{Kufareva2012}.
